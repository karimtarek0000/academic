<template>
  <section role="course-content">
    <div class="row">
      ...
      >
        <div>
          <h3 role="head" class="text-18 text-dark margin-bottom-30">
          ...
          <AccordionAnimate
            ...
            class="accordion-animate--change"
          ...
          >
            ...
            <div slot="title" class="d-flex align-items-center weight-br-300">
              ...
              />
              <div
                class="d-flex text-11 bg-emerald padding-10 text-light radius-9"
              >
            ...
            >
              ...
              >
                ...
                بدءاً من الحروف المفردة مروراً بالحروف المتصلة وثم كتابة الكلمات
                والجمل
              </p>
            </AccordionAnimate>
            <!-- Normal lesson -->
